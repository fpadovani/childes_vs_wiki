...
from train.wrapper import *
from train.create_dataset_splits import *
...
from train.custom_functions import *
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int, 
        required = True,
        help= "Context length for the model input")
    ...
    parser.add_argument(
        ...
        action="store_true",
        default = True, 
        help = "(Optional) Set to False if the model is a clm.")
    
    parser.add_argument(
        '--fig_folder', 
        type=str, 
        help = "(Optional) Folder where to store the figures.")
